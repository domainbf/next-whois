...
export default function GuidePage() {
  ...
  const steps = [
    {
      ...
      subtitle: t("guide.step1_subtitle"),
      desc: t("guide.step1_desc"),
      tip: t("guide.step1_tip"),
      visual: (
            ...
            <div className="rounded-xl border border-border bg-muted/20 p-3 space-y-2">
              <div className="flex items-center gap-2">
                ...
                <div className="ml-auto flex gap-1.5">
                  <div className="rounded-md bg-emerald-100 dark:bg-emerald-900/30 text-emerald-700 dark:text-emerald-400 text-[9px] font-bold px-1.5 py-0.5">{t("active")}</div>
                </div>
              </div>
              <div className="grid grid-cols-2 gap-1.5">
                <div className="rounded-lg bg-muted/40 px-2 py-1.5">
                  <div className="text-[8px] text-muted-foreground">{t("whois_fields.creation_date")}</div>
                  <div className="text-[10px] font-mono font-semibold">1997-09-15</div>
                </div>
                <div className="rounded-lg bg-muted/40 px-2 py-1.5">
                  <div className="text-[8px] text-muted-foreground">{t("whois_fields.expiration_date")}</div>
    ...
    },
    {
      ...
      subtitle: t("guide.step2_subtitle"),
      desc: t("guide.step2_desc"),
      tip: t("guide.step2_tip"),
      visual: (
        <div className="w-full rounded-2xl bg-background border border-border overflow-hidden shadow-sm">
          <div className="p-4 space-y-3">
            ...
            <div className="flex items-center gap-2 px-1">
              ...
              <span className="text-[10px] text-muted-foreground">{t("guide.step2_subtitle")}</span>
            </div>
          </div>
        </div>
      ),
    },
    {
      ...
      subtitle: t("guide.step3_subtitle"),
      desc: t("guide.step3_desc"),
      tip: t("guide.step3_tip"),
      visual: (
        <div className="w-full rounded-2xl bg-background border border-border overflow-hidden shadow-sm">
          <div className="p-4 space-y-2.5">
            ...
            <div className="rounded-xl border border-border bg-muted/20 p-3 space-y-2">
              <div className="flex items-center gap-1.5 text-[10px] text-muted-foreground">
                <RiBellLine className="w-3 h-3" /> {t("whois_fields.expiration_date")}
              </div>
              <div className="flex flex-wrap gap-1.5">
                {["60d","30d","10d","5d","1d"].map((d,i) => (
  ...
  const features = [
    { icon: RiCalendarLine, text: t("guide.feature1") },
    { icon: RiShieldCheckLine, text: t("guide.feature2") },
    { icon: RiTimeLine, text: t("guide.feature3") },
    { icon: RiInformationLine, text: t("guide.feature4") },
  ];
  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content={t("guide.page_meta_desc")} />
      ...
      <div className="min-h-screen bg-gradient-to-b from-background via-background to-muted/20">
        ...
        <div className="sticky top-0 z-10 border-b border-border/50 bg-background/80 backdrop-blur-xl">
          <div className="max-w-lg mx-auto px-4 h-14 flex items-center gap-3">
            ...
            <div>
              <h1 className="text-sm font-bold leading-tight">{t("guide.header_title")}</h1>
              <p className="text-[10px] text-muted-foreground">{t("guide.header_subtitle")}</p>
            </div>
            <div className="ml-auto">
              <Link href="/">
                <Button size="sm" className="h-7 px-3 text-xs rounded-lg gap-1">
                  {t("guide.go_query")} <RiArrowRightLine className="w-3 h-3" />
                </Button>
              </Link>
            </div>
          </div>
        ...
        <div className="max-w-lg mx-auto px-4 pb-16">
          ...
          <div className="pt-8 pb-6 text-center space-y-2">
            ...
            <h2 className="text-2xl font-bold tracking-tight">
              {t("guide.hero_title_1")}<br />
              <span className="text-sky-500">{t("guide.hero_title_2")}</span>
            </h2>
